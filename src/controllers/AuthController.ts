...
class AuthController {
  async registerUser(req: Request, res: Response): Promise<void> {
    try {
      const { name, email, cep, uf, city, address, geolocation, gender, age, photo, race, schoolAccess, scholarity, organizationMembership, organizationCategory, password, role } = req.body;
  ...
  async updateUser(req: Request, res: Response): Promise<void> {
    try {
      ...
      const { name, uf, cep, city, address, geolocation, gender, age, race, schoolAccess, scholarity, organizationMembership, organizationCategory } = req.body; // Dados que podem ser atualizados
